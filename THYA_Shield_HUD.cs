...
List<int> split_string(string shield_name) {
    ...
    List<int> values = new List<int>{Int32.Parse(splitString[0]), Int32.Parse(splitString[1])};
    return values;
}
...
List<int> getData() {
    ...
    List<int> iData = new List<int>{Convert.ToInt32(sData[0]), Convert.ToInt32(sData[1])};
    return iData;
}
